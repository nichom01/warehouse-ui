...
- Admin: Warehouse administration section with sub-items (warehouse, zone, location, user, customer, product)
...
- **AND** Admin SHALL have 6 sub-items (warehouse, zone, location, user, customer, product)
